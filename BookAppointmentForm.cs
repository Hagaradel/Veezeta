...
namespace Vezeeta
{
    public partial class BookAppointmentForm : UserControl
    {
        ...
        string patient_username = "Mostafa", doc_username = null;
        ...
        private void btn_book_Click(object sender, EventArgs e)
        {
            if (list_Appointements.SelectedItems.Count > 0)
            {
                ...
                cmd.Parameters.Add("patient_username", patient_username);
                ...
                if (insert != -1)
                {
                    ...
                    cmd1.CommandText = @"update doc_appointments set is_booked = 1
                                         where doc_appointments.doc_username=:doc_username and doc_appointments.day_time=:day_time";
